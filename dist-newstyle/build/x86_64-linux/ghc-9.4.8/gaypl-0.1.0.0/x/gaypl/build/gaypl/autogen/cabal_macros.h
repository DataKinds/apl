...
/* package gaypl-0.1.0.0 */
#ifndef VERSION_gaypl
#define VERSION_gaypl "0.1.0.0"
#endif /* VERSION_gaypl */
#ifndef MIN_VERSION_gaypl
#define MIN_VERSION_gaypl(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_gaypl */
...
#define CURRENT_COMPONENT_ID "gaypl-0.1.0.0-inplace-gaypl"
